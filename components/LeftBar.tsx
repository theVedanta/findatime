...
const LeftBar = () => {
    return (
        <Box
            ...
            bgcolor="white"
        >
            <Typography mt={6} mb={4} fontWeight={400} fontSize={28}>
                Meeting Info
            </Typography>
            ...
            <Typography mt={1} sx={{ opacity: 0.6 }}>
                *This meeting poll was created in India GMT+4 timezone
            </Typography>
            <Typography fontWeight={200} mt={1} fontStyle="italic">
                Note: This is the poll to decide the best time for Exile members
                to meet to discuss Issue#2
            </Typography>

            <Typography mt={6} mb={1} fontSize={18}>
                Event Poll link
            </Typography>
            <Box
                display="flex"
